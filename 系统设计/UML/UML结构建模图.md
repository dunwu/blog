...
![](http://dunwu.test.upcdn.net/images/design/uml/uml-package-diagram.gif)

包中的元素共享相同的命名空间，因此，一个指定命名空间的元素必须有唯一的名称。

包可以用来代表物理或逻辑关系。选择把类包括在指定的包里，有助于在同一个包里赋予这些类相同继承层次。通常认为把通过复合相关联的类，以及与它们相协作的类放在同一个包里。

![](http://dunwu.test.upcdn.net/images/design/uml/uml-package.gif)
...
![](http://dunwu.test.upcdn.net/images/design/uml/uml-class-diagram.png)
...
![](http://dunwu.test.upcdn.net/images/design/uml/uml-class.gif)

### 接口（Interfaces）

接口是实施者同意满足的行为规范，是一种约定。实现一个接口，类必需支持其要求的行为，使系统按照同样的方式，即公共的接口，处理不相关的元素。

![](http://dunwu.test.upcdn.net/images/design/uml/uml-class-interface.gif)

接口有相似于类的外形风格，含有指定的操作，如下图所示。如果没有明确的详细操作，也可以画成一个圆环。当画成圆环的时候，到这个环形标柱的实现连接没有目标箭头。

![](http://dunwu.test.upcdn.net/images/design/uml/uml-interface.gif)
...
![](http://dunwu.test.upcdn.net/images/design/uml/uml-table.gif)
...
![](http://dunwu.test.upcdn.net/images/design/uml/uml-associations.gif)
...
![](http://dunwu.test.upcdn.net/images/design/uml/uml-generalizations.gif)

下图显示了与上图相同信息的视图。

![](http://dunwu.test.upcdn.net/images/design/uml/uml-generalizations-02.gif)
...
![](http://dunwu.test.upcdn.net/images/design/uml/uml-aggregations.gif)
...
![](http://dunwu.test.upcdn.net/images/design/uml/uml-association-classes.gif)
...
![](http://dunwu.test.upcdn.net/images/design/uml/uml-realizations.gif)
...
![](http://dunwu.test.upcdn.net/images/design/uml/uml-composite-structure-diagram.gif)
...
![](http://dunwu.test.upcdn.net/images/design/uml/uml-part.gif)
...
![](http://dunwu.test.upcdn.net/images/design/uml/uml-port.gif)
...
![](http://dunwu.test.upcdn.net/images/design/uml/uml-interface-02.gif)

### 委托

委托连接器用来定义组件外部端口和接口的内部工作方式。委托连接器表示为带有 «delegate» 关键字的箭头。它连接组件的外部约定，表现为它的端口，到组件部件行为的内部实现。

![](http://dunwu.test.upcdn.net/images/design/uml/uml-delegate.gif)
...
![](http://dunwu.test.upcdn.net/images/design/uml/uml-collaboration.gif)

### 角色绑定

角色绑定连接器是一条从连接协作到所要完成该任务类元的连线。它显示为虚线，并在类元端显示作用名。

![](http://dunwu.test.upcdn.net/images/design/uml/uml-role-binding.gif)

### 表现

表现连接器用于连接协作到类元来表示此类元中使用了该协作。显示为带关键字 «represents»的虚线箭头。

![](http://dunwu.test.upcdn.net/images/design/uml/uml-represent.gif)
