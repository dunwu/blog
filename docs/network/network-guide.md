...
![](http://dunwu.test.upcdn.net/images/network/overview/network-topological-structure.gif)
...
![](http://dunwu.test.upcdn.net/images/network/overview/network-layers.png)
