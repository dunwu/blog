...
<br><div align="center"><img src="http://dunwu.test.upcdn.net/images/refactor/introduce-local-extension-before.png"/></div><br>

**解决**

建立一个新类，使它包含这些额外函数，让这个扩展品成为源类的子类或包装类。

<br><div align="center"><img src="http://dunwu.test.upcdn.net/images/refactor/introduce-local-extension-after.png"/></div><br>
