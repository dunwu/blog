...
- [2. 负载均衡算法](#2-负载均衡算法)
  ...
  - [2.5. 一致性哈希](#25-一致性哈希)
- [3. 负载均衡技术](#3-负载均衡技术)
  - [3.1. DNS 负载均衡](#31-dns-负载均衡)
  - [3.2. HTTP 负载均衡](#32-http-负载均衡)
  - [3.3. 反向代理](#33-反向代理)
  - [3.4. 网络地址转发](#34-网络地址转发)
  - [3.5. 隧道技术](#35-隧道技术)
  - [3.6. 直接路由](#36-直接路由)
  - [3.7. 混合负载均衡](#37-混合负载均衡)
- [4. 术语](#4-术语)
- [5. 参考资料](#5-参考资料)
...
![img](http://dunwu.test.upcdn.net/cs/design/architecture/代理自动配置.png)
...
![img](https://images2015.cnblogs.com/blog/820332/201512/820332-20151213200106747-94797427.png)

以上模式适合有动静分离的场景，反向代理服务器（集群）可以起到缓存和动态请求分发的作用，当时静态资源缓存在代理服务器时，则直接返回到浏览器。如果动态页面则请求后面的应用负载均衡（应用集群）。

方式二，如下图：

![img](https://images2015.cnblogs.com/blog/820332/201512/820332-20151213200117825-1452672107.png)
