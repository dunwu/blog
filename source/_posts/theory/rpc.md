...
- [四、网络通信](#四网络通信)
  - [IO 多路复用](#io-多路复用)
  - [零拷贝](#零拷贝)
- [五、RPC 架构模型](#五rpc-架构模型)
- [六、服务注册和发现](#六服务注册和发现)
  - [基于 ZooKeeper 的服务发现](#基于-zookeeper-的服务发现)
  - [基于消息总线的最终一致性的注册中心](#基于消息总线的最终一致性的注册中心)
- [七、健康检查](#七健康检查)
- [八、路由和负载均衡](#八路由和负载均衡)
  - [超时重试](#超时重试)
  - [限流、降级、熔断](#限流降级熔断)
...
![img](http://dunwu.test.upcdn.net/snap/20200717154300)
...
![img](http://dunwu.test.upcdn.net/snap/20200717154716.jfif)
...
![img](http://dunwu.test.upcdn.net/snap/20200717162006.png)
...
![img](http://dunwu.test.upcdn.net/snap/20200717163401.png)
...
![img](http://dunwu.test.upcdn.net/snap/20200717163921.png)
...
![img](http://dunwu.test.upcdn.net/snap/20200718204407.png)
...
![img](http://dunwu.test.upcdn.net/snap/20200719082205.png)
...
![img](http://dunwu.test.upcdn.net/snap/20200719095518.png)

场景二：搭建一个轻量级的服务网关，可以让各个业务方用 HTTP 的方式，通过服务网关调用其它服务。

![img](http://dunwu.test.upcdn.net/snap/20200719095704.png)
