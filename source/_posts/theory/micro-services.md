...
![img](http://dunwu.test.upcdn.net/snap/20200716203602.png)
...
- 用户端监控：性能、返回码、城市、地区、运营商、版本、系统等。
- 业务监控：核心指标、登录、注册、下单、支付等。
- 应用层监控：访问接口、访问服务、SQL、内存使用率、响应时间、TPS、QPS 等。
- 系统层监控：CPU、内存、网络带宽、磁盘使用率等。
- 基础监控监控：网络流量、丢包数、错包数、连接数等。
