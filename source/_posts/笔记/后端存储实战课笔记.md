...
## 12. MySQL 如何应对高并发（一）：使用缓存保护 MySQL
...
## 24. MySQL 经常遇到的高可用、分片问题，NewSQL 是如何解决的？

安利 CockroachDB、RocksDB、OceanBase

## 25. RocksDB：不丢数据的高性能 KV 存储、
