...
- [命令](#命令)
    - [进入 SQLite 控制台](#进入-sqlite-控制台)
    - [进入 SQLite 控制台并指定数据库](#进入-sqlite-控制台并指定数据库)
    - [退出 SQLite 控制台](#退出-sqlite-控制台)
    - [查看命令帮助](#查看命令帮助)
- [更多内容](#更多内容)
...
> :point_right: 扩展阅读：[SQLite 命令](sqlite-cli.md)
...
> :point_right: 扩展阅读：[SQLite Java API](sqlite-api-java.md)
