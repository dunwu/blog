...
![img](http://dunwu.test.upcdn.net/images/refactor/alternative-classes-with-different-interfaces-1.png)
...
![img](http://dunwu.test.upcdn.net/images/refactor/alternative-classes-with-different-interfaces-2.png)
...
![img](http://dunwu.test.upcdn.net/images/refactor/parameterize-method-before.png)
**解决**

建立单一函数，以参数表达哪些不同的值。

![img](http://dunwu.test.upcdn.net/images/refactor/parameterize-method-after.png)
