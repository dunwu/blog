...
![img](http://dunwu.test.upcdn.net/images/refactor/primitive-obsession-1.png)
...
![img](http://dunwu.test.upcdn.net/images/refactor/primitive-obsession-2.png)
...
![img](http://dunwu.test.upcdn.net/images/refactor/primitive-obsession-3.png)
...
![img](http://dunwu.test.upcdn.net/images/refactor/replace-type-code-with-class-before.png)

**解决**

以一个新的类替换该数值类型码。

![img](http://dunwu.test.upcdn.net/images/refactor/replace-type-code-with-class-after.png)
